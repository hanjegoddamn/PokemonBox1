...
<div class="modal" data-id="disign">
	<div class="wrapper">
		<form method="post" class="modal-content">
			...
			<div class="modal-body">
				<div><i class="icon-con-vk"></i>&nbsp;&nbsp;&nbsp;Сайт слит - <a class="nav-link" href="https://whyleak.xyz">WhyLeak</a> <a class="nav-link" href="https://whyleak.xyz" target="_blank"></a></div>
				<br>
				<div><i class="icon-con-vk"></i>&nbsp;&nbsp;&nbsp;Сайт слит - <a class="nav-link" href="https://whyleak.xyz" target="_blank">WhyLeak</a></div>
				<br>
			</div>
		</form>
	</div>
...
<footer style="padding: 20px;">© 2023 WhyLeak | <a class="nav-link" data-modal="contacts" href="#">Контакты и Реквизиты</a> | <a class="nav-link" data-modal="disign" href="#">Дизайн</a> |<a class="nav-link" data-modal="accept" href="#">Соглашение</a> | <a class="nav-link" data-modal="privacy" href="#">Политика безопасности</a> <br> <a class="nav-link" data-modal="return-terms" href="#">Политика возврата платежей</a> | <a class="nav-link" data-modal="conf" href="#">Политика конфидициальности</a> <br> niklikq | ИНН 000000000000 </footer>
